...
//                        path = "/Users/zhaogx/Downloads/" + teacher_id + "/" + paperproxy_id + "/";
        ...
        com.pms.entity.File file = fileService.findFileByPaperproxyIdAndFileType(Integer.parseInt(paperproxy_id), Integer.parseInt(fileType));
        if (null == file) {
            file = new com.pms.entity.File();
    ...
    public String submit(@RequestParam("paperproxy_id") Integer paperproxy_id, HttpSession session) {
        ...
        // TODO:文件表检查是否有多余记录
        List<com.pms.entity.File> files = fileService.findFileByPaperproxyId(paperproxy_id);
        PaperIssueEnum paperIssue = PaperIssueEnum.getInstance(paper.getPaper_issue());
        switch (paperIssue) {
            case JOURNALS:
                for (com.pms.entity.File file : files) {
...
//        }
    ...
    public List<com.pms.entity.File> getFileByPaperproxyId(@RequestParam("paperproxy_id") Integer paperproxy_id) {
